...
### AW Code:[Bugfix] BugID:99358, system identified 2 launchers, LauncherGoResLib contains manifests
### hence we use LauncherGoResLib, delete AndroidManifest config bellow.
#LOCAL_FULL_LIBS_MANIFEST_FILES := \
